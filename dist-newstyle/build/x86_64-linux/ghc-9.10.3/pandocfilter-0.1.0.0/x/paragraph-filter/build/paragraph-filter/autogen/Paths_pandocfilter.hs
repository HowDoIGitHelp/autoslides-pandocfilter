...
-- at runtime using the environment variable pandocfilter_bindir.
...
-- environment variable pandocfilter_libdir.
...
-- using the environment variable pandocfilter_dynlibdir.
...
-- runtime using the environment variable pandocfilter_datadir.
...
-- variable pandocfilter_libexedir.
...
-- using the environment variable pandocfilter_sysconfdir.
...
libdir     = "/home/rub/.cabal/lib/x86_64-linux-ghc-9.10.3-415c/pandocfilter-0.1.0.0-inplace-paragraph-filter"
dynlibdir  = "/home/rub/.cabal/lib/x86_64-linux-ghc-9.10.3-415c"
datadir    = "/home/rub/.cabal/share/x86_64-linux-ghc-9.10.3-415c/pandocfilter-0.1.0.0"
libexecdir = "/home/rub/.cabal/libexec/x86_64-linux-ghc-9.10.3-415c/pandocfilter-0.1.0.0"
sysconfdir = "/home/rub/.cabal/etc"

getBinDir     = catchIO (getEnv "pandocfilter_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "pandocfilter_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "pandocfilter_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "pandocfilter_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "pandocfilter_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "pandocfilter_sysconfdir") (\_ -> return sysconfdir)
